...
const EventPage = () => {
  ...
  return (
    <div className="bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 flex flex-col min-h-screen min-w-[500px] container mx-auto px-2 md:px-4 flex-grow py-6 md:py-8">
      {loading && (
